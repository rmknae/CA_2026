...
//ONLY THESE INSTRUCTIONS WILL BE TESTED
...
endtask
    ...
    initial begin
        ...
        // Test branch taken (BEQ, rs1==rs2, branch TAKEN -> rd5 never written, rd6 written)
        ...
        // Test branch not taken (BEQ, rs1!=rs2 -> falls through to addr+1)
        `IMEM_PATH.memory[INST_ADDR + 0] = {IMM[12], IMM[10:5], 5'd2, 5'd1, BR_TYPE[0], IMM[4:1], IMM[11], `OPC_BRANCH};
        `IMEM_PATH.memory[INST_ADDR + 1] = {`FNC7_0, 5'd4, 5'd3, `FNC_ADD_SUB, 5'd5, `OPC_ARI_RTYPE};
